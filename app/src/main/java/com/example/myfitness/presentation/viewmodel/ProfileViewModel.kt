...
class ProfileViewModel(
    ...
    fun onNameChange(v: String) {
        _state.value = _state.value.copy(name = v, isSaved = false)
    }

    fun onGenderChange(v: String) {
        _state.value = _state.value.copy(gender = v, isSaved = false)
    }

    fun onEmailChange(v: String) {
        _state.value = _state.value.copy(email = v, isSaved = false)
    }

    fun onWeightChange(v: String) {
        _state.value = _state.value.copy(weight = v, isSaved = false)
    }

    fun onHeightChange(v: String) {
        _state.value = _state.value.copy(height = v, isSaved = false)
    }

    fun onTargetChange(v: String) {
        _state.value = _state.value.copy(target = v, isSaved = false)
    }
